...
namespace Strongman
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        [HarmonyPostfix]
        static void Awake_Postfix(ref int ___maxShingleAmmo, ref int ___maxBrickAmmo, ref HandToFront.GenericStuffs ____refLibrary)
        {
            ___maxShingleAmmo = maxShingles.Value;
            ___maxBrickAmmo = maxBricks.Value;
            Array.Resize<Transform>(ref ____refLibrary.shingleHolder.GetComponent<BrickCarrierLogic>().brickLocs, ___maxShingleAmmo);
            Array.Resize<Transform>(ref ____refLibrary.brickHolder.GetComponent<BrickCarrierLogic>().brickLocs, ___maxBrickAmmo);
